		...
		<div class="sideMenu" style="margin: 0 auto">
			...
			<ul>
				<li><a class="dh" href="/Views/Admin/addExamer.html"
					target="right">学员信息录入</a></li>
				<li><a class="dh" href="/Views/Admin/updateExamer.html"
					target="right">学员信息更新</a></li>
				<li><a class="dh" href="/Views/Admin/selectExamer.html"
					target="right">学员信息查询</a></li>
			</ul>
			<h3>题库管理</h3>
			<ul>
				<li><a class="dh" href="/Views/Exam/stdl.html" target="right">考题大类设置</a></li>
				<li><a class="dh" href="/Views/Exam/stlb.html" target="right">考题类别设置</a></li>
				<li><a class="dh" href="/Views/Exam/stlx.html" target="right">考题类型设置</a></li>
				<li><a class="dh" href="/Views/Exam/addst.html" target="right">添加考题</a></li>
				<li><a class="dh" href="/Views/Exam/selectST.html"
					target="right">考题查询</a></li>
			</ul>
			<h3>学员成绩管理</h3>
			<ul>
			...
			<ul>
				<li><a class="dh" href="/Views/Exam/err-info.html"
					target="right">成绩统计</a></li>
				<li><a class="dh" href="/Views/Admin/system.html"
					target="right">实体统计</a></li>
				<li><a class="dh" href="/Views/Admin/system.html"
					target="right">题库信息测试</a></li>
				<%--<li><a class="dh" href="/Views/Admin/system.html"
					target="right">未完待续</a></li>--%>
			</ul>
			<%--<h3>系统初始化</h3>
